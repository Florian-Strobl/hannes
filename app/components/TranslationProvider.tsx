...
const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    'home.availableMeats': 'Available Meat Offers',
    'home.search': 'Search meats...',
    'home.clear': 'Clear',
    'home.noOffers': 'No offers yet',
    'home.noOffersSub': 'Fresh cuts coming soon. Check back later.',
    'home.buy': 'Buy',
    'home.price': 'Price',
    'home.stock': 'Stock',
    'home.outOfStock': 'Out of stock',
    'home.yourOrders': 'Your Orders',
    'home.cancelOrder': 'Cancel Order',
    ...
    'register.errorOccurred': 'An error occurred',
    'register.success': 'Registration successful! Please login.',
    'register.pinCreate': 'Create 4-digit PIN',
    'register.farmerExists.info': 'ℹ️ A farmer account already exists. Only one farmer can register. The existing farmer must delete their account before a new farmer can register.',
    'register.farmerExists.warning': '⚠️ Cannot register as farmer. A farmer account already exists. The existing farmer must delete their account first.',
    'common.notAvailable': 'Not available',
    'home.theme': 'Theme',
    'home.themeSubtitle': 'Customize appearance before signing in.',
    ...
    'profile.newPassword': 'New Password (leave empty to keep current)',
    'profile.confirmPassword': 'Confirm Password',
    'profile.newPin': 'New PIN (leave empty to keep current)',
    ...
    'profile.pinLength': 'PIN must be 4 digits',
    ...
    'reset.title': 'Reset Password/PIN',
    'reset.passwordTab': 'Reset Password',
    'reset.pinTab': 'Reset PIN',
    'reset.newPassword': 'New Password',
    'reset.confirmPassword': 'Confirm Password',
    'reset.newPin': 'New 4-digit PIN',
    'reset.confirmPin': 'Confirm PIN',
    'reset.resetting': 'Resetting...',
    'reset.reset': 'Reset',
    'reset.valuesMismatch': 'Values do not match',
    'reset.requiredPassword': 'Password is required',
    'reset.requiredPin': 'PIN is required',
    'reset.success': 'Reset successfully! You can now login with your new {type}.',
    'reset.emailMissing': 'Email does not exist!',
    'reset.failed': 'Reset failed',
    'reset.errorOccurred': 'An error occurred',
    'admin.accessDenied': 'Access Denied',
    'admin.title': 'Admin Panel',
    'admin.addMeat': 'Add Meat',
    'admin.name': 'Name',
    'admin.price': 'Price',
    'admin.stockKg': 'Stock (kg)',
    'admin.manageMeats': 'Manage Meats',
    ...
    'admin.errorAddMeat': 'Error adding meat',
    'admin.errorClearOrder': 'Error removing order',
    'admin.errorDeleteMeat': 'Error deleting meat',
    'admin.errorDeleteUser': 'Error deleting user',
    'admin.confirmDeleteMeat': 'Are you sure you want to delete this meat?',
    'admin.confirmDeleteUser': 'Delete this user and all their orders?',
    'forgot.title': 'Reset {type}',
    'forgot.link': 'Forgot {type}?',
    'forgot.info': 'Enter your email and we\'ll send you a verification code to reset your {type}.',
    'forgot.sendCode': 'Send Code',
    'forgot.sending': 'Sending...',
    'forgot.cancel': 'Cancel',
    'forgot.emailRequired': 'Email is required',
    'forgot.codeSent': 'A verification code has been sent to {email}. Please check your email.',
    'forgot.failedRequest': 'Failed to process request',
    'forgot.errorOccurred': 'An error occurred',
    'forgot.verifyInfo': 'Enter the 6-digit verification code sent to your email.',
    'forgot.invalidCode': 'Please enter a valid 6-digit code',
    'forgot.verifying': 'Verifying...',
    'forgot.verifyCode': 'Verify Code',
    'forgot.back': 'Back',
    'forgot.verifySuccess': 'Verification successful! You can now open the reset link.',
    'forgot.verifyFailed': 'Verification failed',
    'forgot.openLink': 'Open Reset Link',
    'forgot.close': 'Close',
    'forgot.type.password': 'password',
    'forgot.type.pin': 'PIN',
    'forgot.type.passwordLower': 'password',
  ...
  fr: {
    ...
    'home.yourOrders': 'Vos commandes',
    'home.cancelOrder': 'Annuler la commande',
  ...
  es: {
    ...
    'home.yourOrders': 'Tus pedidos',
    'home.cancelOrder': 'Cancelar pedido',
    'home.quantity': 'Cantidad',
    'home.total': 'Total',
    'home.date': 'Fecha',
